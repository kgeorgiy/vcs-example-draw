...
public class ImageUtil {
    public static void writeImage(String file, BufferedImage image) throws IOException {
...
//        param.setCompressionQuality(quality);
    ...
    public static void showImage(final BufferedImage image) throws IOException {
